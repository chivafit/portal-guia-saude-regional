...
- Build Android `bundleRelease`: aprovado com SDK 36 e Gradle 8.14.3. O AAB gerado é **não assinado** (`jarsigner -verify`), portanto ainda não serve para envio à Play Store.

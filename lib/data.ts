...
export type Organization = {
  slug: string;
  name: string;
  /** Variações públicas de nome usadas exclusivamente para busca e relacionamento. */
  aliases?: string[];
  category: string;
  ...
  lastVerifiedAt?: string;
  updatedAt?: string;
  /** Horário exibido somente quando sustentado por fonte atual. */
  hours?: string;
  neighborhood?: string;
  state?: string;
  postalCode?: string;
  ...
  sponsored?: boolean;
  displayOrder?: number;
  /** Resumo editorial público específico; evita expor notas operacionais da base. */
...
const piumhiImportedProfessionals: Professional[] = [
  ...
  { slug: "dra-wanessa-dornela-de-oliveira-otorrino-piumhi", name: "Dra. Wanessa Dornela de Oliveira", profession: "Médico", specialty: "Otorrinolaringologia", city: "Piumhi", organization: "Clínica Salutare — Rua Ramiro Júlio Ferreira, 90, Centro", registration: "CRM-MG · aguardando validação", verified: false, summary: "Cadastro baseado em fonte pública. Registro profissional e detalhes de atendimento permanecem pendentes de confirmação editorial.", phone: "Contato a validar", whatsapp: "#", services: ["Otorrinolaringologia"], source: "https://www.santacasapiumhi.com.br/_files/ugd/cf977d_cea3da1b207f412d961c37652d6d2854.pdf" },
  ...
  { slug: "dra-gabriela-rezende-odontologia-piumhi", name: "Dra. Gabriela Rezende", profession: "Dentista", specialty: "Odontologia", city: "Piumhi", organization: "Instituto Nomma — Rua Nossa Senhora do Livramento, 161, Centro", registration: "CRO-MG 69674", verified: true, summary: "Cirurgiã-dentista com atendimento informado no Instituto Nomma, em Piumhi.", phone: "(37) 3412-2277", whatsapp: "https://wa.me/5537998094837", services: ["Odontologia geral", "Odontopediatria", "Tratamento de canal"], source: "https://dragabrielarezende.codental.site/" },
...
const piumhiImportedOrganizations: Organization[] = [
  ...
  { slug: "instituto-nomma-piumhi", name: "Instituto Nomma", category: "Clínica odontológica", city: "Piumhi", address: "Rua Nossa Senhora do Livramento, 161, Centro", phone: "(37) 99941-2277", summary: "Instituto de saúde com endereço e telefone públicos confirmados; os serviços publicados permanecem restritos aos dados verificados.", services: ["Odontologia"], logoUrl: "/placeholders/company-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.acharei.com.br/mg/piumhi/empresas/medicina_saude_e_equipamentos?pagina=2" },
  ...
  { slug: "phd-piumhi-hospital-dia", name: "PHD Piumhi Hospital Dia", aliases: ["Hospital Dia PHD", "GGHTP Medicina Diagnóstica", "GGHTP"], category: "Hospital", city: "Piumhi", address: "Praça Guia Lopes, 278, Centro", phone: "(37) 3412-0075", summary: "Contato público confirmado no site oficial do PHD Piumhi Hospital Dia. GGHTP Medicina Diagnóstica é tratado como estrutura relacionada, sem página independente.", services: ["Centro cirúrgico", "Exames de imagem", "Especialidades"], logoUrl: "/placeholders/company-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://phdhospitaldia.com.br/acessos/", website: "https://phdhospitaldia.com.br/" },
  ...
  { slug: "clinica-salutare-piumhi", name: "Clínica Salutare", category: "Clínica multiprofissional", city: "Piumhi", address: "Rua Ramiro Júlio Ferreira, 90, Centro", phone: "Contato a validar", summary: "Endereço público conferido em material institucional recente; telefone e demais detalhes permanecem em validação editorial.", services: ["Especialidades médicas", "Otorrinolaringologia"], logoUrl: "/placeholders/company-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.santacasapiumhi.com.br/_files/ugd/cf977d_cea3da1b207f412d961c37652d6d2854.pdf" },
  ...
  { slug: "borboletando-clinica-reabilitacao-piumhi", name: "Borboletando Clínica Multidisciplinar de Reabilitação", category: "Clínica multiprofissional", city: "Piumhi", address: "Rua Armando Viotti, 373, Centro", phone: "(37) 3371-4763", summary: "Endereço e telefone público confirmados em registro atualizado do Cadastro Nacional de Estabelecimentos de Saúde.", services: ["Fisioterapia", "Reabilitação", "Psicologia"], logoUrl: "/placeholders/company-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151504945557" },
  ...
  { slug: "fisiocenter-piumhi", name: "Fisiocenter — Fisioterapia e Quiropraxia", aliases: ["Fisiocenter", "FisioCenter", "Centro de Fisioterapia, Posturologia e Quiropraxia"], category: "Fisioterapia e reabilitação", city: "Piumhi", address: "Rua Tenente Freitas, 538, Centro", phone: "(37) 3412-2748", whatsapp: "https://wa.me/5537998123014", summary: "Centro de fisioterapia e quiropraxia com contato e serviços públicos identificados em Piumhi.", services: ["Fisioterapia", "Quiropraxia", "Pilates", "RPG", "Acupuntura", "Atendimento domiciliar"], logoUrl: "/placeholders/company-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.solutudo.com.br/empresas/mg/piumhi/fisioterapia/fisiocenter-fisioterapia-e-quiropraxia-22258077" },
  ...
  { slug: "rfitness-piumhi", name: "RFitness Saúde & Bem-Estar", category: "Academia e atividade física", city: "Piumhi", address: "Rua Nossa Senhora do Livramento, 612, Centro", phone: "(37) 99858-9619", summary: "Academia com contato público listado em diretório comercial local. Informações complementares permanecem em revisão editorial.", services: ["Musculação", "Bem-estar", "Condicionamento físico"], logoUrl: "/placeholders/company-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://wellhub.com/pt-br/search/partners/rfitness-saude-bem-estar-centro/", website: "https://rfitness.com.br" },
  ...
  { slug: "clinica-mais-saude-gms-piumhi", name: "Clínica Mais Saúde GMS", aliases: ["Mais Saúde", "GMS", "GMS Grupo Melhor Saúde", "Grupo Melhor Saúde"], category: "Clínica multiprofissional", city: "Piumhi", address: "Rua Padre Abel, 191 e 194, Centro", phone: "(37) 99935-8585", summary: "Clínica multiprofissional com profissionais e endereço públicos identificados em Piumhi.", services: ["Especialidades médicas", "Psicologia", "Nutrição"], logoUrl: "/placeholders/company-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.doctoralia.com.br/clinicas/piumhi" },
...
const publishedOrganizationConfig: Record<string, Partial<Organization>> = {
  ...
  "laboratorio-bioanalise-piumhi": { categoryKey: "laboratorios", subcategories: ["Análises clínicas"], keywords: ["laboratório", "bioanálise", "análises clínicas", "exames laboratoriais"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 195 },
  "rizo-centro-odontologico-piumhi": { categoryKey: "odontologia", subcategories: ["Clínica odontológica"], keywords: ["rizo", "odontologia", "dentista", "saúde bucal"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 25 },
  "clinica-mais-saude-gms-piumhi": { categoryKey: "clinicas", subcategories: ["Clínica multiprofissional"], keywords: ["mais saúde", "gms", "grupo melhor saúde", "clínica", "especialidades"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 38 },
  "phd-piumhi-hospital-dia": { categoryKey: "hospitais", subcategories: ["Hospital", "Diagnóstico por imagem"], keywords: ["hospital", "exames", "imagem", "diagnóstico"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 40 },
  "clinica-ophtalmocenter-piumhi": { categoryKey: "clinicas", subcategories: ["Clínica multiprofissional"], keywords: ["clínica", "oftalmologia", "olhos"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 50 },
  "clinica-do-coracao-piumhi": { categoryKey: "clinicas", subcategories: ["Clínica multiprofissional"], keywords: ["clínica", "cardiologia", "coração"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 60 },
  "nucleo-dermatologico-cirurgico-piumhi": { categoryKey: "clinicas", subcategories: ["Clínica multiprofissional"], keywords: ["clínica", "dermatologia"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 70 },
  ...
  "sport-mais-academia-piumhi": { categoryKey: "academias", subcategories: ["Academia e atividade física"], keywords: ["academia", "musculação", "atividade física"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 90 },
  "rfitness-piumhi": { categoryKey: "academias", subcategories: ["Academia e atividade física"], keywords: ["academia", "musculação", "atividade física"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 100 },
  "oficina-do-corpo-piumhi": { categoryKey: "academias", subcategories: ["Academia e atividade física"], keywords: ["academia", "musculação", "atividade física"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 110 },
  "mergulho-natacao-piumhi": { categoryKey: "academias", subcategories: ["Academia e atividade física"], keywords: ["natação", "hidroginástica", "academia", "atividade física"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 120 },
  "piumhi-tenis-clube-academia": { categoryKey: "academias", subcategories: ["Academia e atividade física"], keywords: ["academia", "atividade física", "clube"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 130 },
  "academia-equilibrio-piumhi": { categoryKey: "academias", subcategories: ["Academia e atividade física"], keywords: ["academia", "treino funcional", "atividade física"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 140 },
  "drogaria-americana-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia"], keywords: ["farmácia", "drogaria", "medicamentos"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 150 },
  "natus-farma-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia"], keywords: ["farmácia", "drogaria", "remédio", "medicamento", "medicamentos"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 151 },
  "farmelhor-centro-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia"], keywords: ["farmácia", "drogaria", "remédio", "medicamento", "medicamentos", "delivery"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 152 },
  "drogamelo-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia de manipulação"], keywords: ["farmácia", "drogaria", "medicamentos", "manipulação", "farmácia de manipulação"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 153 },
  "drogarias-ultrapopular-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia"], keywords: ["farmácia", "drogaria", "remédio", "medicamento", "medicamentos"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 154 },
  "poupa-minas-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia"], keywords: ["farmácia", "drogaria", "remédio", "medicamento", "medicamentos"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 155 },
  "farmalucas-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia"], keywords: ["farmácia", "drogaria", "remédio", "medicamento", "medicamentos"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 156 },
  "drogamais-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia"], keywords: ["farmácia", "drogaria", "remédio", "medicamento", "medicamentos"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 157 },
  "biomagistral-farmaceutica-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia de manipulação"], keywords: ["farmácia", "drogaria", "medicamentos", "manipulação", "farmácia de manipulação", "homeopatia"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 158 },
  "rosa-farma-manipulacao-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia de manipulação"], keywords: ["farmácia", "drogaria", "medicamentos", "manipulação", "farmácia de manipulação"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 159 },
  "entrefarma-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia"], keywords: ["farmácia", "drogaria", "remédio", "medicamento", "medicamentos"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 161 },
  "drogaria-nossa-senhora-livramento-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia"], keywords: ["farmácia", "drogaria", "remédio", "medicamento", "medicamentos"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 162 },
  "central-otica-piumhi": { categoryKey: "oticas", subcategories: ["Ótica"], keywords: ["ótica", "óculos", "lentes", "visão"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 160 },
  "barufarma-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia de manipulação"], keywords: ["farmácia", "manipulação", "farmácia de manipulação", "medicamentos", "delivery"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 170 },
  "solucao-farma-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia de manipulação"], keywords: ["farmácia", "drogaria", "medicamentos", "manipulação", "farmácia de manipulação", "rede inova"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 180 },
  "certus-laboratorio-piumhi": { categoryKey: "laboratorios", subcategories: ["Análises clínicas"], keywords: ["laboratório", "exames", "análises clínicas", "coleta"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 190 },
  "primelab-piumhi": { categoryKey: "laboratorios", subcategories: ["Análises clínicas"], keywords: ["laboratório", "exames", "análises clínicas", "coleta"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 200 },
  "santa-casa-piumhi": { categoryKey: "hospitais", subcategories: ["Hospital filantrópico", "Atendimento SUS"], keywords: ["hospital", "santa casa", "atendimento hospitalar", "sus"], verificationStatus: "public-source", publicationStatus: "published", lastVerifiedAt: "2026-08-28", displayOrder: 210 },
  "centro-reabilitacao-hidroterapia-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • Reabilitação"], keywords: ["rede pública", "sus", "fisioterapia sus", "reabilitação", "hidroterapia"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 220 },
  ...
  "psf-bossuet-costa-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • SUS"], keywords: ["ubs", "psf", "esf", "posto de saúde", "sus", "rede pública", "saúde da família"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 240 },
  "psf-inho-firmino-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • SUS"], keywords: ["ubs", "psf", "esf", "posto de saúde", "sus", "rede pública", "saúde da família"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 241 },
  "ubs-joao-guilherme-to-rural-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • SUS"], keywords: ["ubs", "psf", "esf", "posto de saúde", "sus", "rede pública", "saúde da família", "chico neca"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 242 },
  "psf-joaquim-terra-dos-santos-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • SUS"], keywords: ["ubs", "psf", "esf", "posto de saúde", "sus", "rede pública", "saúde da família"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 243 },
  "psf-jose-martins-de-faria-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • SUS"], keywords: ["ubs", "psf", "esf", "posto de saúde", "sus", "rede pública", "saúde da família"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 244 },
  "ubs-arlindo-barbosa-neto-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • SUS"], keywords: ["ubs", "psf", "esf", "posto de saúde", "sus", "rede pública", "saúde da família", "marcinho contador"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 245 },
  "ubs-mitermyer-alves-terra-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • SUS"], keywords: ["ubs", "psf", "esf", "posto de saúde", "sus", "rede pública", "saúde da família", "mitermayer"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 246 },
  "psf-sarah-vitoria-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • SUS"], keywords: ["ubs", "psf", "esf", "posto de saúde", "sus", "rede pública", "saúde da família"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 247 },
  "psf-sudario-dos-santos-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • SUS"], keywords: ["ubs", "psf", "esf", "posto de saúde", "sus", "rede pública", "saúde da família"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 248 },
  "ubs-totonha-tome-dona-tina-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • SUS"], keywords: ["ubs", "psf", "esf", "posto de saúde", "sus", "rede pública", "saúde da família", "totonha tomé", "dona tina"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 249 },
  "caps-ii-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • Saúde Mental"], keywords: ["caps", "caps ii", "saúde mental", "sus", "rede pública"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 250 },
  "caps-ad-desafio-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • Saúde Mental"], keywords: ["caps", "caps ad", "saúde mental", "sus", "rede pública"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 251 },
  "servico-municipal-diagnostico-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • Diagnóstico"], keywords: ["sus", "rede pública", "exame sus", "diagnóstico sus", "exames laboratoriais", "diagnóstico"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 252 },
  "ceo-socrates-alves-da-costa-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • Saúde Bucal"], keywords: ["ceo", "ceo piumhi", "odontologia sus", "dentista sus", "saúde bucal", "sus", "rede pública"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 253 },
  "central-municipal-vacinacao-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • Vacinação"], keywords: ["vacinação", "vacina", "vacina sus", "central de vacinação", "sus", "rede pública"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 254 },
  "farmacia-municipal-helvidio-menezes-piumhi": { categoryKey: "farmacias", subcategories: ["Rede pública • Assistência Farmacêutica"], keywords: ["farmácia municipal", "farmácia sus", "farmácia do sus curumim", "assistência farmacêutica", "medicamentos", "sus", "rede pública"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 255 },
};
...
const vettedLocalOrganizations: Organization[] = [
  ...
  { slug: "rizo-centro-odontologico-piumhi", name: "Rizo Centro Odontológico", aliases: ["RIZO", "Rizo Centro Odontológico - Unidade Piumhi"], category: "Clínica odontológica", city: "Piumhi", address: "Rua Padre Abel, 202, loja 05, Centro", phone: "(37) 99961-7901", whatsapp: "https://wa.me/5537999617901", summary: "Clínica odontológica com unidade e contato público informados em Piumhi.", services: ["Odontologia"], source: "https://cnpj.biz/41404448000158" },
  { slug: "drogaria-americana-piumhi", name: "Drogaria Americana", aliases: ["Drogamelo I", "Farmácia Vitória"], category: "Farmácia", city: "Piumhi", address: "Rua Padre Abel, 365, Centro", phone: "(37) 3371-1122", summary: "", publicSummary: "Farmácia com atendimento presencial e produtos farmacêuticos em Piumhi.", services: ["Medicamentos", "Produtos de saúde", "Perfumaria"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.santacasapiumhi.com.br/_files/ugd/cf977d_cea3da1b207f412d961c37652d6d2854.pdf" },
  { slug: "natus-farma-piumhi", name: "Natus Farma", category: "Farmácia", city: "Piumhi", address: "Praça Padre Alberico, 73, Centro", phone: "", summary: "", publicSummary: "Unidade da Natus Farma com retirada de produtos em Piumhi.", services: ["Medicamentos", "Produtos de saúde", "Retirada na loja"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.natusfarma.com.br/store/retire-na-praca-padre-alberico-73-centro-piumhi-mg-mg-37925-000/119", website: "https://www.natusfarma.com.br/store/retire-na-praca-padre-alberico-73-centro-piumhi-mg-mg-37925-000/119" },
  { slug: "farmelhor-centro-piumhi", name: "FarMelhor Centro", aliases: ["Farmarília", "Farmácia Pereira Garcia", "Drogaria FarMelhor Farmarília"], category: "Farmácia", city: "Piumhi", address: "Rua Padre Abel, 163, Centro", phone: "(37) 99862-5112", whatsapp: "https://wa.me/5537998625112", summary: "", publicSummary: "Unidade FarMelhor no Centro de Piumhi, com atendimento presencial e pedidos por delivery.", services: ["Medicamentos", "Produtos de saúde", "Delivery"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://unidades.franquiafarmelhor.com.br/farmelhor-centro-piumhi-mg-73447", website: "https://unidades.franquiafarmelhor.com.br/farmelhor-centro-piumhi-mg-73447" },
  { slug: "drogamelo-piumhi", name: "Drogamelo", aliases: ["Drogamelo II", "Farmácia Drogamelo"], category: "Farmácia de manipulação", city: "Piumhi", address: "Praça Guia Lopes, 352, Centro", phone: "", summary: "", publicSummary: "Farmácia de manipulação com unidade identificada no Centro de Piumhi.", services: ["Manipulação de fórmulas", "Medicamentos", "Produtos farmacêuticos"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://cnpj.biz/20106498000189" },
  { slug: "drogarias-ultrapopular-piumhi", name: "Drogarias Ultrapopular", aliases: ["Drogaria Ultra Popular", "Drogaria Melo Coelho"], category: "Farmácia", city: "Piumhi", address: "Rua Padre Abel, 207, Centro", phone: "", summary: "", publicSummary: "Unidade das Drogarias Ultrapopular no Centro de Piumhi.", services: ["Medicamentos", "Produtos de saúde", "Perfumaria"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.econodata.com.br/consulta-empresa/08049349000120-drogaria-melo-coelho-ltda" },
  { slug: "poupa-minas-piumhi", name: "Poupa Minas", aliases: ["Drogaria Stefany Oliveira", "Drogaria Stefany Oliveira Ltda", "Márcia Maria Lopes"], category: "Farmácia", city: "Piumhi", address: "Rua Padre Abel, 750, Centro", phone: "(37) 3412-0467", summary: "", publicSummary: "Farmácia com unidade identificada no Centro de Piumhi.", services: ["Medicamentos", "Produtos de saúde", "Perfumaria"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.solutudo.com.br/empresas/mg/piumhi/farmacias/drogaria-stefany-oliveira-ltda-625683" },
  { slug: "farmalucas-piumhi", name: "Farmalucas", aliases: ["Farmácia Faria", "Farmácia Faria Júlio", "Farmacia Faria Julio Ltda"], category: "Farmácia", city: "Piumhi", address: "Rua Severo Veloso, 1070, sala 02, Nova Esperança", phone: "", summary: "", publicSummary: "Farmácia com unidade identificada no bairro Nova Esperança, em Piumhi.", services: ["Medicamentos", "Produtos de saúde", "Perfumaria"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://cnpj.biz/15401481000114" },
  { slug: "drogamais-piumhi", name: "Drogamais", aliases: ["Drogaria Neves e Almeida", "Drogaria Neves e Almeida Ltda"], category: "Farmácia", city: "Piumhi", address: "Rua Severo Veloso, 1127, Nova Esperança", phone: "(37) 3412-1222", whatsapp: "https://wa.me/553734121222", summary: "", publicSummary: "Farmácia com unidade e contato público identificados no bairro Nova Esperança, em Piumhi.", services: ["Medicamentos", "Produtos de saúde", "Perfumaria"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://casadosdados.com.br/solucao/cnpj/drogaria-neves-e-almeida-ltda-29283051000150" },
  { slug: "biomagistral-farmaceutica-piumhi", name: "Biomagistral Farmacêutica", aliases: ["Biomagistral", "Matos Almeida Farmácia de Manipulação"], category: "Farmácia de manipulação", city: "Piumhi", address: "Praça Francisco Campos, 210, salas 218 e 228, Centro", phone: "(37) 99911-3532", whatsapp: "https://wa.me/5537999113532", summary: "", publicSummary: "Farmácia de manipulação com unidade identificada no Centro de Piumhi.", services: ["Manipulação de fórmulas", "Medicamentos", "Homeopatia"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.econodata.com.br/consulta-empresa/60624755000199-matos-almeida-farmacia-de-manipulacao-ltda" },
  { slug: "rosa-farma-manipulacao-piumhi", name: "Rosa Farma Manipulação", aliases: ["Drogaria Piumhi", "Droga Rede", "Droga Rede 098", "Drogaria Piumhi Ltda"], category: "Farmácia de manipulação", city: "Piumhi", address: "Rua Artur Rodrigues da Costa, 140, Centro", phone: "(37) 3371-2555", whatsapp: "https://wa.me/553733712555", summary: "", publicSummary: "Farmácia de manipulação com unidade e contato público identificados no Centro de Piumhi.", services: ["Manipulação de fórmulas", "Medicamentos", "Produtos farmacêuticos"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://casadosdados.com.br/solucao/cnpj/drogaria-piumhi-ltda-19717412000175" },
  { slug: "entrefarma-piumhi", name: "Entrefarma", aliases: ["Entrefarma Para Todos", "Drogaria Para Todos", "Drogaria Soares e Oliveira", "Drogaria Soares e Oliveira Ltda"], category: "Farmácia", city: "Piumhi", address: "Rua Armando Viotti, 263, Centro", phone: "(37) 3371-1818", summary: "", publicSummary: "Unidade Entrefarma com atendimento presencial no Centro de Piumhi.", services: ["Medicamentos", "Produtos de saúde", "Perfumaria"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.waze.com/live-map/directions/br/mg/farmacias-entrefarma?to=place.ChIJg1lCkJITtJQR56gLuPjCUhw", website: "https://www.entrefarma.com.br/" },
  { slug: "drogaria-nossa-senhora-livramento-piumhi", name: "Drogaria Nossa Senhora do Livramento", aliases: ["Uai Farma", "Uai Farma Drogaminas", "Drogaminas", "Drogaria Nossa Senhora do Livramento Ltda"], category: "Farmácia", city: "Piumhi", address: "Rua Joaquim Beijo, 526, Nova Brasília", phone: "", summary: "", publicSummary: "Farmácia com unidade identificada no bairro Nova Brasília, em Piumhi.", services: ["Medicamentos", "Produtos de saúde", "Perfumaria"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://www.solutudo.com.br/empresas/mg/piumhi/farmacias/drogaria-nossa-senhora-do-livramento-ltda-8327526" },
  ...
  { slug: "barufarma-piumhi", name: "Barufarma", aliases: ["Baru Farma"], category: "Farmácia de manipulação", city: "Piumhi", address: "Rua Santo Antônio, 62, Centro", phone: "(37) 98825-9083", whatsapp: "https://wa.me/5537988259083", summary: "", publicSummary: "Farmácia de manipulação com atendimento em Piumhi e serviço de entrega informado no canal oficial.", services: ["Manipulação de fórmulas", "Medicamentos", "Homeopatia", "Delivery"], hours: "Segunda a sexta, 8h–18h30; sábado, 8h–12h", logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://manipulacaobarufarma.com.br/", website: "https://manipulacaobarufarma.com.br/" },
  ...
  { slug: "psf-inho-firmino-piumhi", name: "PSF Inhô Firmino", aliases: ["PSF Inho Firmino", "UBS Inhô Firmino", "ESF Inhô Firmino"], category: "Rede pública • SUS", city: "Piumhi", address: "Rua Lavras, 117, Lagoa de Trás", phone: "(37) 3371-3535", summary: "", publicSummary: "Unidade de saúde da família da rede pública municipal.", services: ["Atenção primária à saúde"], source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151503243907" },
  { slug: "ubs-joao-guilherme-to-rural-piumhi", name: "UBS João Guilherme Alves “Tó” e Rural", aliases: ["João Guilherme", "João Guilherme Tó", "Tó", "PSF Tó", "ESF Tó", "PSF Rural", "ESF Rural", "Rural", "Chico Neca"], category: "Rede pública • SUS", city: "Piumhi", address: "Rua Antônio Rui Almada, 115, Elisa Leonel", phone: "(37) 3371-3535", summary: "", publicSummary: "Estrutura física que reúne as referências de saúde da família Tó e Rural.", services: ["Atenção primária à saúde"], source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151503243893" },
  { slug: "psf-joaquim-terra-dos-santos-piumhi", name: "PSF Joaquim Terra dos Santos", aliases: ["UBS Joaquim Terra", "ESF Joaquim Terra"], category: "Rede pública • SUS", city: "Piumhi", address: "Rua João Leite, 682, Santo Antônio", phone: "(37) 3371-3535", summary: "", publicSummary: "Unidade de saúde da família da rede pública municipal.", services: ["Atenção primária à saúde"], source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151502775468" },
  { slug: "psf-jose-martins-de-faria-piumhi", name: "PSF José Martins de Faria", aliases: ["UBS José Martins de Faria", "ESF José Martins de Faria"], category: "Rede pública • SUS", city: "Piumhi", address: "Rua Arthur Rodrigues da Costa, 157, Centro", phone: "", summary: "", publicSummary: "Unidade de saúde da família da rede pública municipal.", services: ["Atenção primária à saúde"], source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151502172917" },
  { slug: "ubs-arlindo-barbosa-neto-piumhi", name: "UBS Arlindo Barbosa Neto “Marcinho Contador”", aliases: ["Marcinho Contador", "PSF Marcinho Contador", "ESF Marcinho Contador", "UBS Marcinho Contador", "Arlindo Barbosa Neto"], category: "Rede pública • SUS", city: "Piumhi", address: "Rua Francisco Soares Ferreira, 1240, Nova Esperança", phone: "", summary: "", publicSummary: "Unidade básica de saúde da rede pública municipal.", services: ["Acolhimento", "Enfermagem", "Consultas médicas", "Odontologia", "Equipe multiprofissional (e-Multi)", "Exames", "Curativos", "Planejamento familiar"], hours: "Segunda a sexta, 7h–17h", source: "https://prefeiturapiumhi.mg.gov.br/municipio-inaugura-a-14a-unidade-basica-de-saude-nesta-sexta-feira-09/" },
  { slug: "ubs-mitermyer-alves-terra-piumhi", name: "UBS Mitermyer Alves Terra", aliases: ["Mitermayer Alves Terra", "UBS Mitermayer Alves Terra", "ESF Mitermyer", "PSF Mitermyer"], category: "Rede pública • SUS", city: "Piumhi", address: "Rua Geralda Cordoval Brandão, 136, Novo Tempo", phone: "", summary: "", publicSummary: "Unidade básica de saúde da rede pública municipal.", services: ["Atenção primária à saúde"], hours: "Segunda a sexta, 7h–17h", source: "https://prefeiturapiumhi.mg.gov.br/inauguracao-da-ubs-mitermyer-alves-terra-marca-mais-um-avanco-na-saude-de-piumhi/" },
  { slug: "psf-sarah-vitoria-piumhi", name: "PSF Sarah Vitória", aliases: ["UBS Sarah Vitória", "ESF Sarah Vitória"], category: "Rede pública • SUS", city: "Piumhi", address: "Rua Clodomiro Clóvis Cunha, 86, Nova Piumhi", phone: "", summary: "", publicSummary: "Unidade de saúde da família da rede pública municipal.", services: ["Atenção primária à saúde"], source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151500994758" },
  { slug: "psf-sudario-dos-santos-piumhi", name: "PSF Sudário dos Santos", aliases: ["UBS Sudário dos Santos", "ESF Sudário dos Santos"], category: "Rede pública • SUS", city: "Piumhi", address: "Rua São Vicente, 1025, Vila Nova", phone: "(37) 3371-1780", summary: "", publicSummary: "Unidade de saúde da família da rede pública municipal.", services: ["Atenção primária à saúde"], source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151502775751" },
  { slug: "ubs-totonha-tome-dona-tina-piumhi", name: "UBS Totonha Tomé e Dona Tina", aliases: ["Totonha Tomé", "Dona Tina", "PSF Totonha Tomé", "PSF Dona Tina", "ESF Totonha Tomé", "ESF Dona Tina"], category: "Rede pública • SUS", city: "Piumhi", address: "Rua Ari Almada, 523, Nova Esperança", phone: "", summary: "", publicSummary: "Estrutura física que reúne as referências de saúde da família Totonha Tomé e Dona Tina.", services: ["Atenção primária à saúde"], source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151502775786" },
  { slug: "caps-ii-piumhi", name: "CAPS II Piumhi", aliases: ["CAPS Piumhi", "Centro de Atenção Psicossocial"], category: "Rede pública • Saúde Mental", city: "Piumhi", address: "Praça Dr. Avelino de Queiroz, 394, Centro", phone: "(37) 3371-9256", summary: "", publicSummary: "Centro de Atenção Psicossocial da rede pública municipal.", services: ["Atenção psicossocial"], hours: "Segunda a sexta, 8h–17h", source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151502147408" },
  { slug: "caps-ad-desafio-piumhi", name: "CAPS AD Desafio", aliases: ["CAPS AD", "CAPS AD Piumhi", "Desafio"], category: "Rede pública • Saúde Mental", city: "Piumhi", address: "Rua Dr. Higino, 142, Centro", phone: "(37) 3371-9288", summary: "", publicSummary: "Centro de Atenção Psicossocial Álcool e Drogas da rede pública municipal.", services: ["Atenção psicossocial para álcool e outras drogas"], source: "https://cnes2.datasus.gov.br/Mod_Basico.asp?VCo_Unidade=3151507666128" },
  { slug: "servico-municipal-diagnostico-piumhi", name: "Serviço Municipal de Diagnóstico por Imagem e Exames Laboratoriais", aliases: ["Diagnóstico Municipal", "Exames SUS", "Laboratório SUS"], category: "Rede pública • Diagnóstico", city: "Piumhi", address: "Rua Padre Abel, 1431, Pindaíbas", phone: "(37) 3371-9204", summary: "", publicSummary: "Serviço municipal de diagnóstico por imagem e exames laboratoriais.", services: ["Diagnóstico por imagem", "Exames laboratoriais"], hours: "Segunda a sexta, 7h–17h", source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151502172887" },
  { slug: "ceo-socrates-alves-da-costa-piumhi", name: "Centro de Especialidades Odontológicas Sócrates Alves da Costa", aliases: ["CEO", "CEO Piumhi", "Centro de Especialidades Odontológicas", "Dentista SUS", "Odontologia SUS"], category: "Rede pública • Saúde Bucal", city: "Piumhi", address: "Rua Tabelião Ovídio Arantes, 212, Centro", phone: "(37) 3371-9987", summary: "", publicSummary: "Centro municipal de especialidades odontológicas.", services: ["Especialidades odontológicas"], hours: "Segunda a sexta, 7h–17h", source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151506146813" },
  { slug: "central-municipal-vacinacao-piumhi", name: "Central Municipal de Vacinação Julieta Luiza da Silveira Castro", aliases: ["Central de Vacinação", "Vacinação", "Vacina", "Vacina SUS"], category: "Rede pública • Vacinação", city: "Piumhi", address: "Rua Rafaela Gonçalves Tomé, 132, Centro", phone: "", summary: "", publicSummary: "Central municipal de vacinação em Piumhi.", services: ["Vacinação"], source: "https://prefeiturapiumhi.mg.gov.br/campanha-de-vacinacao-contra-a-gripe-ja-esta-em-andamento-em-piumhi-e-neste-sabado-acontece-o-dia-d/" },
  { slug: "farmacia-municipal-helvidio-menezes-piumhi", name: "Farmácia Municipal Helvídio Menezes", aliases: ["Farmácia Municipal", "Farmácia SUS", "Farmácia do SUS Curumim", "Helvídio Menezes"], category: "Rede pública • Assistência Farmacêutica", city: "Piumhi", address: "Rua Padre Abel, 1381, Pindaíbas", phone: "", summary: "", publicSummary: "Unidade municipal de assistência farmacêutica para atendimento pelo SUS.", services: ["Assistência farmacêutica", "Medicamentos pelo SUS"], logoUrl: "/placeholders/pharmacy-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151506144691" },
];
...
export const podcasts: PodcastEpisode[] = [
  { slug: "biomagistral-farmacia-manipulacao", imageUrl: "https://i.ytimg.com/vi/uNyNAvumGdk/hqdefault.jpg", guest: "Biomagistral", role: "Farmácia de manipulação", topic: "Conexão Saúde com a Biomagistral", date: "8 de setembro de 2026", duration: "Episódio completo", status: "Disponível", episodeUrl: "https://www.youtube.com/watch?v=uNyNAvumGdk" },
  ...
  { slug: "conexao-saude-elisa-ribeiro", imageUrl: "/podcast/elisa-ribeiro.jpg", guest: "Elisa Ribeiro", role: "Convidada", topic: "Conexão Saúde com Elisa Ribeiro", date: "3 de fevereiro de 2026", duration: "Episódio completo", status: "Disponível", episodeUrl: "https://www.youtube.com/watch?v=v7ymTasSRqQ" },
  { slug: "neurologia-marcio-jr", imageUrl: "/podcast/marcio-jr-neurologia.jpg", guest: "Dr. Márcio Jr.", role: "Neurologista", topic: "Neurologia: conversa com Dr. Márcio Jr.", date: "20 de janeiro de 2026", duration: "Episódio completo", status: "Disponível", episodeUrl: "https://www.youtube.com/watch?v=l22gPtreStc" },
  { slug: "oftalmologia-sergio-paulo", imageUrl: "/podcast/sergio-paulo-oftalmologia.jpg", guest: "Dr. Sérgio Paulo", role: "Oftalmologista", topic: "Oftalmologia: conversa com Dr. Sérgio Paulo", date: "25 de novembro de 2025", duration: "Episódio completo", status: "Disponível", episodeUrl: "https://www.youtube.com/watch?v=C3c7ZF6GFPo" },
  { slug: "ginecologia-sem-tabu-larissa-vaz", imageUrl: "/podcast/larissa-vaz-ginecologia.jpg", guest: "Larissa Vaz", role: "Ginecologia", topic: "Ginecologia sem tabu: o que toda mulher gostaria de perguntar", date: "11 de novembro de 2025", duration: "Episódio completo", status: "Disponível", episodeUrl: "https://www.youtube.com/watch?v=XjiBi9U267g" },
  { slug: "emagrecer-manter-peso-natalia-faria", imageUrl: "/podcast/natalia-faria-emagrecimento.jpg", guest: "Natália Faria", role: "Convidada", topic: "Como emagrecer e manter o peso", date: "28 de outubro de 2025", duration: "Episódio completo", status: "Disponível", episodeUrl: "https://www.youtube.com/watch?v=xW22O4Feims" },
  { slug: "natacao-saude-inclusao-raquel-moraes", imageUrl: "/podcast/raquel-moraes-natacao.jpg", guest: "Raquel Moraes", role: "Convidada", topic: "Corpo em movimento: a natação como ferramenta de saúde e inclusão", date: "14 de outubro de 2025", duration: "Episódio completo", status: "Disponível", episodeUrl: "https://www.youtube.com/watch?v=s7CFriHPhbA" },

...
const piumhiImportedOrganizations: Organization[] = [
  ...
  { slug: "clinica-ophtalmocenter-piumhi", name: "Clínica Ophtalmocenter", category: "Clínica multiprofissional", city: "Piumhi", address: "Praça Tuiuti, 160, 2º andar, Centro", phone: "(37) 3371-2626", summary: "Contato público listado para a unidade na Praça Tuiuti. Demais informações do cadastro permanecem em revisão editorial.", services: ["Oftalmologia", "Saúde ocular"], logoUrl: "/placeholders/company-logo.svg", coverImageUrl: "/placeholders/clinic-cover.svg", source: "https://ophtalmocenter.com.br/" },

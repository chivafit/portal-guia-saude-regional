...
const publishedOrganizationConfig: Record<string, Partial<Organization>> = {
  ...
  "barufarma-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia de manipulação"], keywords: ["farmácia", "manipulação", "medicamentos"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 170 },
  "solucao-farma-piumhi": { categoryKey: "farmacias", subcategories: ["Farmácia"], keywords: ["farmácia", "drogaria", "medicamentos"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-08", displayOrder: 180 },
  ...
  "farmacia-municipal-helvidio-menezes-piumhi": { categoryKey: "servicos-publicos", subcategories: ["Rede pública • Assistência Farmacêutica"], keywords: ["farmácia municipal", "farmácia sus", "assistência farmacêutica", "sus", "rede pública"], verificationStatus: "official-source", publicationStatus: "published", lastVerifiedAt: "2026-09-09", displayOrder: 255 },
};
...
const vettedLocalOrganizations: Organization[] = [
  ...
  { slug: "farmacia-municipal-helvidio-menezes-piumhi", name: "Farmácia Municipal Helvídio Menezes", aliases: ["Farmácia Municipal", "Farmácia SUS", "Helvídio Menezes"], category: "Rede pública • Assistência Farmacêutica", city: "Piumhi", address: "Rua Padre Abel, 1381, Pindaíbas", phone: "", summary: "", publicSummary: "Unidade municipal de assistência farmacêutica.", services: ["Assistência farmacêutica"], source: "https://cnes2.datasus.gov.br/Mod_Conjunto.asp?VCo_Unidade=3151506144691" },
];

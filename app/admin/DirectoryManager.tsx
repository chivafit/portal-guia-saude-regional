...
export function DirectoryManager(){
  ...
  function switchEntity(next: Entity){setEntity(next);setLoading(true);setEditingId(null);setForm(initial);setError("")}

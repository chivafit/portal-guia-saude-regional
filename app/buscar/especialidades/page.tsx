...
function SpecialtiesDirectory() {
  ...
  return <main className="native-specialties-screen"><div className="native-search-aura" aria-hidden="true" /><div className="native-specialties-shell">
    <header className="native-search-header"><Link className="native-search-back" href="/buscar" aria-label="Voltar"><ArrowLeft size={20} /></Link><div className="native-search-title"><h1>Especialidades</h1><p>Explore as especialidades disponíveis no Guia Saúde em Piumhi.</p></div></header>

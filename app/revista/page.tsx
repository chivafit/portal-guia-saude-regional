...
export default function RevistaPage(){
  ...
  return <main className="native-magazine-screen"><div className="native-magazine-shell">
    <HealthOSSectionHeader eyebrow="BIBLIOTECA DIGITAL" title="Revista Guia Saúde" description="Informação para cuidar melhor, em uma experiência feita para o app." backHref="/materias" meta={`${published.length} edições`} />

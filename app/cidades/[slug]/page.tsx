    ...
    <>
      ...
      <main className={rootLanding ? "root-guide-home" : undefined}>
        ...
        <section className="shell content-section city-portal-section">
          <div className="city-pro-directory" id="profissionais"><div className="city-pro-main"><div className="city-block-head"><div><p className="eyebrow">Seleção do Guia Saúde</p><h2>Profissionais em destaque</h2></div><span className="city-featured-criterion">Conheça profissionais que participaram do podcast Guia Saúde</span></div>
            ...
            <Link className="city-list-all" href="/profissionais-destaque">Ver todos os profissionais destaque <ArrowRight size={14} /></Link></div>

...
export function AppBootstrap() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      const dock = document.querySelector(".health-os-dock, .app-bottom-nav");
    ...
    void import("@capacitor/core").then(({ Capacitor }) => {
      ...
      if (Capacitor.isNativePlatform()) {
        ...
        const motionTargets = document.querySelectorAll<HTMLElement>([
          ...
          ".health-os-home .health-os-search",
          ".health-os-home .health-os-shortcuts > *",
          ".health-os-home .health-os-feature",
          ".health-os-home .health-os-section",
          ".health-os-home .health-os-content-card",
          ".home-featured-spatial-card",
          ".native-search-discovery > *",
          ".native-specialties-list > a",
          ".native-search-results .native-professional-card",
          ".native-search-results .native-business-card",
          ".native-category-grid > a",
